...
//    [self dismiss];
    ...
    [self performShouldChangeCharactersDelegateMethodInRange:NSMakeRange(0, 0) replacementString:@""];
}
...
- (IBAction)backSpaceIconButtonPressed {
    ...
    {
        [self performShouldChangeCharactersDelegateMethodInRange:NSMakeRange(0, 1) replacementString:@""];
        [_numbers removeLastObject];
        [self outputNumbers];
    }
    else
